...
urls = (
    ...
    '/site'    , 'panelSite',       # 网站管理
    '/data'    , 'panelData',       # 数据管理
    '/files'   , 'panelFiles',      # 文件管理
    '/ftp'     , 'panelFtp',        # FTP管理
    '/database', 'panelDatabase',   # 数据库
    '/firewall', 'panelFirewall',   # 防火墙
    '/config'  , 'panelConfig',     # 面板设置
    '/crontab' , 'panelCrontab',    # 计划任务
    '/login'   , 'panelLogin',      # 登录退出
    '/code'    , 'panelCode',       # 代码管理
    '/system'  , 'panelSystem',     # 系统管理
    '/ajax'    , 'panelAjax',       # 异步请求
    '/install' , 'panelInstall',    # 安装管理
    '/download', 'panelDownload',   # 下载管理
    '/control' , 'panelControl',    # 监控管理
    '/soft'    , 'panelSoft',       # 软件管理
    '/cloud'   , 'panelCloud',      # 云管理
    '/test'    , 'panelTest',       # 测试管理
    '/close'   , 'panelClose',      
    '/plugin'  , 'panelPlugin',     # 插件管理
    '/waf'     , 'panelWaf',        # 安全管理
    '/ssl'     , 'panelSSL',
    '/api'     , 'panelApi',
    '/hook'    , 'panelHook',
...
# 宝塔数据文件,sqlite,默认的存储目录为/data/session.db
